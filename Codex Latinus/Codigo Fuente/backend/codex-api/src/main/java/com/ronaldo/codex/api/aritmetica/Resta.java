...
public class Resta extends Aritmetica {
    ...
    public Resta(Expresion valorUno, Expresion valorDos, int fila, int columna) {
    ...
    public void verificarSemantica(Semantica semantica) throws Exception {
        ...
        if (tipoUno == Tipo.TEXTUM || tipoDos == Tipo.TEXTUM) {
            ...
            semantica.getErrores().add(new ErrorSemantico(
                    ...
                    columna,
                    "-",
                    "El tipo TEXTUM no es compatible con la operación de resta."
            ));
            return;
        }
        ...
        if (jerarquiaUno == -1 || jerarquiaDos == -1) {
            ...
            semantica.getErrores().add(new ErrorSemantico(
                    ...
                    columna,
                    "-",
                    "No se pueden restar estos tipos (" + tipoUno + " - " + tipoDos + ")."
            ));
            return;
        }
